(function(app) {
    ...
    */
        ...
        name: "曹操",
        group: "10",
        basic: "君主。每夜2个ID指认" + app.roleLinkArray["1004"] + "/" + app.roleLinkArray["1005"] + "/" + app.roleLinkArray["1006"] + "、" + app.roleLinkArray["1010"]+ "/" + app.roleLinkArray["1011"] + "、" + app.roleLinkArray["1012"]+ "/" + app.roleLinkArray["1013"]+ "。每夜1个ID指认" + app.roleLinkArray["1101"] + "、" + app.roleLinkArray["1217"] + "、" + app.roleLinkArray["1319"] + "、" + app.roleLinkArray["1321"] + "，均不能得到反馈。死亡后选择以" + app.roleLinkArray["1002"] + "或" + app.roleLinkArray["1003"] + "的角色继续游戏。",
        skills: [
            ...
            {name: "青梅煮酒", content: "被动技能。当成功指认出" + app.roleLinkArray["1101"] + "时触发。与刘备互识，魏蜀联盟成立，为期两天两夜。不可被继承。（指认技能）"},
            ...
            {name: "分道扬镳", content: "被动技能。当成功指认出" + app.roleLinkArray["1321"] + "且" + app.roleLinkArray["1321"] +"已加入非魏国的国家时触发。当夜及之后" + app.roleLinkArray["1321"] +"【请出就戮】无法触发。不可被继承。（指认技能）"},
        	{name: "血战官渡", content: "被动技能。当成功指认出" + app.roleLinkArray["1319"] + "且" + app.roleLinkArray["1319"] +"已加入非魏国的国家时触发。当夜及之后" + app.roleLinkArray["1319"] + "发动【河朔称雄】时对魏国角色无效。不可被继承。（指认技能）"},
        ],
        attr: "智者、统帅、文豪、能吏",
        faq: [
        ...
        faq: [
        	...
        	{content: "荀彧触发【奇计百出】时，若之前指认的2个智者没有可以学习的主动技能，反馈【奇计百出】触发并消耗，荀彧没有学到技能。"}
        ],
        alias: [
            {content: "" + app.roleLinkArray["2005"] + "（三国版杀单挑-标准）"}
        ]
    }, {
    	id: "1006",
    	name: "荀攸",
        ...
        skills: [
        	{name: "曹魏谋主", content: "被动技能。（1）当魏国军师受到刺杀时触发，一半几率令该刺杀无效；（2）当魏国角色受到强度为致伤的技能作用时触发，抵御一次。同时满足两个条件时，优先触发（1），同时受到多个技能作用时，随机保护一个。（军师增益技能）"},
        	{name: "经达权变", content: "主动技能。指定2个ID，若其非同国，则发动当夜，这2个ID只能受到自己或对方的指认和技能作用。其对其他角色所有的指认和主动技能均失败，其他角色对这2个ID的指认和发动的主动技能也失败。若技能指定了包括这2个ID在内的多个角色，则技能发动成功，但对这2个ID无效。同理，当此2个ID发动了针对包括自己在内的多个目标的技能，则此技能发动成功，但是对其他角色无效。其他角色释放的状态技能对这2个ID无效，这2个ID释放的状态技能对其他角色无效。（军师增益技能 结算前生效）"},
        	{name: "围城焚粮", content: "主动技能。指定1个ID，若其非魏国角色，则对其进行一次非杀手刺杀。若此ID在当夜受到其他任何以其作为目标的主动技能作用，则此刺杀无效。（武将杀伤技能 结算时生效）"},
        ...
        alias: [
            {content: "" + app.roleLinkArray["2006"] + "（三国版杀单挑-标准）"}
        ]
    }, {
    	id: "1007",
    	name: "贾诩",
        ...
        skills: [
        	...
        	{name: "兵不厌诈", content: "主动技能。指定1个ID，令其当夜所有行动失败，失败的技能视作已经消耗一次使用次数。不可被继承。（军师负面技能 结算前生效）"},
        ...
        skills: [
        	{name: "铜墙铁壁", content: "被动技能。当魏国军师受到武将杀伤技能作用时触发，为其抵御一次。（武将保护技能）"},
        ...
        skills: [
        	{name: "拔矢啖睛", content: "被动技能。当第一次被刺杀时触发，不会死亡只会受伤，但从此失去指认能力。若因触发此技能导致夏侯惇伤判结果为死亡，则次夜可写一条遗言，并计入次夜阵亡人数。不可被继承。（武将保护技能）"},
        	{name: "曹氏宗亲", content: "被动技能。当成功指认出" + app.roleLinkArray["1001"] + "时触发，二人互相认识。可以被继承。（指认技能）"}
        ],
        attr: "猛将、能吏",
        faq: [
        	{content: "发身份时，魏国杀手需要在三个角色中选择2个登场，反馈天庭后，再由天庭随机抽取两位杀手的ID和扮演角色的对应关系。"}
        ],
        alias: []
    }, {
    	id: "1011",
        ...
        skills: [
        	{name: "南郡破敌", content: "被动技能。当成功指认出" + app.roleLinkArray["1204"] + "/" + app.roleLinkArray["1205"] + "时触发，令其受伤。如果" + app.roleLinkArray["1204"] + "已被" + app.roleLinkArray["1104"] + "成功指认触发【舌战群儒】，则" + app.roleLinkArray["1204"] + "此次受伤不可痊愈，伤判一半概率死亡一半概率继续受伤，若伤判结果为继续受伤，" + app.roleLinkArray["1204"] + "下夜结算时脱离游戏。（指认技能）"},
        ...
        skills: [
        	...
        	{name: "三日五百", content: "主动技能。夏侯渊登场第三夜开始可以使用，发动当夜除魏国杀手正常刺杀外，夏侯渊可额外指定1个ID进行刺杀。可以被继承。（武将杀伤技能 结算时生效）"},
        	{name: "六日一千", content: "主动技能。夏侯渊登场第六夜开始可以使用，发动当夜除魏国杀手正常刺杀外，夏侯渊可额外指定1个ID进行刺杀。可以被继承。（武将杀伤技能 结算时生效）"},
        ...
        faq: [
        	{content: "发身份时，魏国杀手需要在三个角色中选择2个登场，反馈天庭后，再由天庭随机抽取两位杀手的ID和扮演角色的对应关系。"},
        	{content: "夏侯渊【三日五百】和【六日一千】是主动技能，不能和夏侯渊自己的刺杀同时使用。但是当夏侯渊受到" + app.roleLinkArray["1313"] + "【其疾如风】等技能影响可以多次行动时，【三日五百】、【六日一千】可以和刺杀同时发动，也可以同时发动这2个技能。 "}
        ],
        alias: []
    }, {
    	id: "1013",
        ...
        skills: [
        	{name: "坚壁清野", content: "主动技能。指定1个ID，如果该ID不是君主，则当夜可为其抵御一次武将杀伤技能或军师负面技能。（武将保护技能 结算时生效）"},
    	...
    	skills: [
            {name: "名门闺秀", content: "被动技能。与" + app.roleLinkArray["1324"] + "互识时触发，可随机学会一个" + app.roleLinkArray["1324"] + "的主动技能，包括" + app.roleLinkArray["1324"] + "继承得来的技能。不可被继承。（指认技能）"},
	    ...
	    skills: [
            ...
            {name: "承道受业", content: "被动技能。与" + app.roleLinkArray["1323"] + "互识时触发，可随机学会一个" + app.roleLinkArray["1323"] + "的主动技能。（指认技能）"},
	    ...
	    skills: [
	    	...
	    	{name: "火烧博望", content: "被动技能。当成功指认出" + app.roleLinkArray["1010"] + "时触发，使其受伤。该技能触发后【火烧新野】失效。不可被继承。（指认技能）"},
	    	{name: "火烧新野", content: "被动技能。当成功指认出" + app.roleLinkArray["1011"] + "时触发，使其受伤。该技能触发后【火烧博望】失效。不可被继承。（指认技能）"},
        ...
        skills: [
            ...
            {name: "水淹七军", content: "主动技能。指定1个ID，令其当夜所有行动失败，失败的技能视作已经消耗一次使用次数。不可被继承。（军师负面技能 结算前生效）"},
        ...
        skills: [
            {name: "父兄之佑", content: "被动技能，当吴国角色需要概率判定时触发，可以提交2个数字，按照较好的结果达成。若孙权需要概率判定时，达成最优结果。优先优待孙权的概率判定。（军师增益技能）"},
        ],
        attr: "仁者、能吏",
        faq: [],
        alias: []
        ...
        name: "周瑜",
        group: "12",
        basic: "军师。若" + app.roleLinkArray["1202"] + "选择与周瑜结义，则即时得知" + app.roleLinkArray["1202"] + "登场的消息。第四夜结算时自然死亡，死后所有指认信息转告君主。每夜2个ID指认" + app.roleLinkArray["1206"] + "/" + app.roleLinkArray["1207"] + "、" + app.roleLinkArray["1212"] + "。每夜2个ID指认用于触发【雄才大略】。每夜指认1个ID，得知其一项评价。死亡后以" + app.roleLinkArray["1205"] + "的角色继续游戏。",
        skills: [
        ...
        name: "太史慈",
        group: "12",
        basic: "杀手。开局知道" + app.roleLinkArray["1212"] + "。若" + app.roleLinkArray["1202"] + "选择与太史慈结义，则即时得知" + app.roleLinkArray["1202"] + "登场的消息。每夜1个ID指认" + app.roleLinkArray["1202"] + "/" + app.roleLinkArray["1203"] + "。每夜指认1个ID为仁者。死亡后选择以" + app.roleLinkArray["1210"] + "或" + app.roleLinkArray["1211"] + "的角色继续游戏。",
        skills: [
            {name: "北海解围", content: "被动技能，非锁定技。与" + app.roleLinkArray["1315"] + "互识后可以选择于某夜触发。当夜" + app.roleLinkArray["1315"] + "【君子让梨】可以额外指定一个作用目标。不可被继承。（指认技能）"},
        ...
        name: "蒋钦",
        group: "12",
        basic: "杀手。" + app.roleLinkArray["1209"] + "的继承者。每夜1个ID指认" + app.roleLinkArray["1202"] + "/" + app.roleLinkArray["1203"] + "、" + app.roleLinkArray["1215"] + "。每夜指认1个ID为仁者。",
        skills: [
            {name: "忘私举贤", content: "主动技能。" + app.roleLinkArray["1216"] + "在场时可以使用。当夜蒋钦可以使用" + app.roleLinkArray["1216"] + "的一个技能，技能属性由原本的技能决定。（军师增益技能）"},
            {name: "横锁九江", content: "主动技能。" + app.roleLinkArray["1215"] + "在场时可以使用。当夜" + app.roleLinkArray["1215"] + "使用的技能，蒋钦也可以使用一次，目标ID由蒋钦指定。技能属性由原本的技能决定。（无属性技能）"},
            {name: "奋敌护主", content: "被动技能。非锁定技。若" + app.roleLinkArray["1212"] + "/" + app.roleLinkArray["1213"] + "发动【百骑劫营】当夜，【百骑劫营】未抵挡武将杀伤技能则可选择触发。下夜" + app.roleLinkArray["1212"] + "/" + app.roleLinkArray["1213"] + "可额外指定1个ID致伤。（武将杀伤技能）"},
        ],
        attr: "猛将、义士",
        faq: [],
        alias: []
        ...
        skills: [
            ...
            {name: "浪里擒将", content: "主动技能。指定1个ID，令其当夜所有行动失败，失败的技能视作已经消耗一次使用次数。（军师负面技能 结算前生效）"},
        ],
        attr: "猛将、义士",
        faq: [],
        alias: []
        ...
        name: "貂蝉",
        group: "13",
        basic: "平民。在野时投票无效。每夜1个ID指认女眷，指认出后相互认识。死亡后以" + app.roleLinkArray["1304"] + "的角色继续游戏。",
        skills: [
            {name: "闭月羞花", content: "被动技能，触发次数不限。当被武将杀伤技能作用时触发，一半概率抵御该武将杀伤技能。若刺杀者为" + app.roleLinkArray["1110"] + "，该技能不触发。不可被继承。（武将保护技能）"},
            {name: "媚眼如丝", content: "主动技能，可使用三次。指定1个ID，若该角色为男性角色，则控制该ID次日的投票，可以与自己不一致。修改后的投票显示在票面公告上。不可被继承。（投票技能 结算时生效）"},
            {name: "祸水红颜", content: "主动技能。指定2个ID，若作用对象都为男性角色，则两人进行拼点，失败者受伤。次日【祸水红颜】使用者投票无效，拼点胜利者次日投票算作两票。下夜【祸水红颜】使用者可继续指定另1个ID与胜利者拼点。如果其为男性，则技能发动成功，以此类推。若作用对象为女性角色，则技能发动失败，不可再用。在使用【祸水红颜】时，若貂蝉前一夜触发了【闭月羞花】或指认互识了非本国女眷，则在当夜拼点胜利者视为对失败者发动一次非杀手刺杀。此技能被其他角色学习后只能使用一次。不可被继承。（军师负面技能 结算时生效）"},
        ...
        skills: [
            ...
            {name: "人遁", content: "主动技能。指定A、B2个ID，当夜所有针对A和B这2个ID的指向性行动将被互相替换。（军师增益技能 结算前生效）"},
        ],
        attr: "智者、异人",
        faq: [],
        alias: []
        ...
        skills: [
            {name: "巧施连环", content: "主动技能。成功指认出" + app.roleLinkArray["1303"] + "时由天庭通知王允此技能生效。王允可以选择在某夜指定1个ID，该夜若" + app.roleLinkArray["1301"] + "状态正常，则" + app.roleLinkArray["1301"] + "强制刺杀该ID。该次刺杀无视" + app.roleLinkArray["1301"] + "阵营，该次刺杀不影响" + app.roleLinkArray["1301"] + "【朝秦暮楚】的刺杀，效果与【朝秦暮楚】中刺杀的效果一致。若指定的刺杀对象为" + app.roleLinkArray["1301"] + "或" + app.roleLinkArray["1303"] + "，则此次命令失效，【巧施连环】视作已经消耗。<br/>若本版" + app.roleLinkArray["1303"] + "不在场，则王允对" + app.roleLinkArray["1303"] + "的指认从第四夜起可以用于指认" + app.roleLinkArray["1301"] + "，成功指认出" + app.roleLinkArray["1301"] + "时，天庭通知此技能生效。王允可以选择在某夜指定1个ID，该夜若" + app.roleLinkArray["1301"] + "状态正常，则" + app.roleLinkArray["1301"] + "强制刺杀该ID。该次刺杀无视" + app.roleLinkArray["1301"] + "阵营，该次刺杀不影响" + app.roleLinkArray["1301"] + "【朝秦暮楚】的刺杀，但效果仅为普通非杀手刺杀。若指定的刺杀对象为" + app.roleLinkArray["1301"] + "，则此次命令失效，【巧施连环】视作已经消耗。<br/>若本版" + app.roleLinkArray["1301"] + "不在场，成功指认出" + app.roleLinkArray["1303"] + "时，天庭通知生效。可选择在某一夜使用，当夜及当夜之后" + app.roleLinkArray["1303"] + "第一次使用【祸水红颜】时，王允得知【祸水红颜】的作用ID并可以指定获胜者。<br/>不可被继承。（军师增益技能 结算时生效）"},
        ...
        skills: [
            {name: "镜花水月", content: "被动技能，触发次数不限。当【镜花水月】拥有者被指认时触发，所有指认到【镜花水月】拥有者的角色，皆被【镜花水月】拥有者得到自己的随机一项评价。当有2个可以互相认识的角色指认过【镜花水月】拥有者后（不限于同一夜），这两名角色可以得知彼此身份。可以触发依赖双向指认触发的被动技能。不可触发依赖单向指认触发的技能。不可被继承。（指认技能）"},
        ...
        name: "袁绍",
        group: "13",
        basic: "平民。在野时投票无效。每夜指认1个ID具有某项评价的角色（由袁绍指定）。每夜1个ID指认三国君主。死亡后以" + app.roleLinkArray["1320"] + "的角色继续游戏。",
        skills: [
            {name: "广结名士", content: "被动技能，触发次数不限。袁绍/" + app.roleLinkArray["1320"] + "每夜指认评价时若指认为正确，则下夜可选择一个其他评价进行指认，若指认为错误，下夜不能更换指认的评价。可以被继承。（指认技能）"},
            {name: "讨董联盟", content: "被动技能。袁绍在野时，指认到" + app.roleLinkArray["1001"] + "、" + app.roleLinkArray["1101"] + "、" + app.roleLinkArray["1201"] + "时触发；袁绍入国后，指认到非本阵营的对应君主才触发，使袁绍和指认到的君主次日投票均算作2票。若" + app.roleLinkArray["1317"] + "在场，则使" + app.roleLinkArray["1317"] + "下一次使用时【雄霸天下】刺杀有一半概率失效，但阻止三国杀手刺杀的效果仍然有效，若【雄霸天下】已经消耗，则令" + app.roleLinkArray["1317"] + "当夜发动的所有行动失败。不可被继承。（指认技能）"},
            {name: "刚愎自用", content: "被动技能，触发次数不限。袁绍进行伤判时，结果变化为：痊愈——死亡，继续受伤——痊愈且立即生效，死亡——死亡并计入下夜死亡人数且下夜可以写一条遗言。不可被继承。（无属性技能）"},
            {name: "四世三公", content: "被动技能，非锁定技，可触发三次。袁绍/" + app.roleLinkArray["1320"] + "在进行受伤判定时，在得知结果之后可以重新进行判定，可以被继承。（军师增益技能）"},
            {name: "空墙苟活", content: "被动技能，当袁绍在某夜受到伤害（非最终结算）时触发,可抵御效果最大的一次。不可被继承。（军师增益技能）"},
            {name: "名门望族", content: "被动技能，袁绍/" + app.roleLinkArray["1320"] + "第一次受伤时，或者正确的评价指认达到两个及以上触发，使袁绍/" + app.roleLinkArray["1320"] + "【四世三公】之后可以作用于互识同国角色的伤判。可以被继承。（军师增益技能）"},
            {name: "强弩射阵", content: "主动技能。指定包括自己在内的3个ID，令他们同时受伤。不可被继承。（武将杀伤技能 结算时生效）"},
            {name: "河朔称雄", content: "主动技能，入国后才可以使用，作用于所有被袁绍指认过评价的ID。若为非同国角色。由袁绍判定随机使一个ID当夜行动发动失败。不可被继承。（军师增益技能 结算时生效）"},
        ],
        attr: "统帅、雅士",
        faq: [],
        alias: []
        ...
        name: "袁术",
        group: "13",
        basic: "平民。" + app.roleLinkArray["1319"] + "的继承者。在野时投票无效。每夜指认1个ID具有某项评价的角色（由袁术指定）。",
        skills: [
            {name: "割据淮南", content: "主动技能。提交1个ID，使其当夜使用的所有主动技能目标ID替换为袁术。（军师负面技能）"},
            {name: "袁氏嫡子", content: "主动技能，登场两夜后可以使用，可以指定1个ID，对其发动一次非杀手刺杀。（武将杀伤技能 结算时生效）"},
            {name: "渴思蜜水", content: "被动技能。【袁氏嫡子】使用后，每夜袁术进行一次判定，该判定一半概率使袁术当夜结算时脱离游戏（没有遗言但计入死伤）。（军师增益技能）"},
        ],
        attr: "雅士",
        faq: [],
        alias: []
        ...
        skills: [
            ...
            {name: "平反大将", content: "被动技能。当被非魏国人杀死时触发，第一个杀死流寇的国家，若君主存在，则可由君主选择一个ID，自由学会" + app.roleLinkArray["1325"] + "的三个技能中的一个，但学来的【水能载舟】只能触发一次。若有2个或以上国家同时杀死流寇，则此技能无法触发。（无属性技能）"},
        ],
        attr: "异人",
        faq: [],
        alias: []
        ...
        skills: [
            ...
            {name: "平反大将", content: "被动技能。当被非蜀国人杀死时触发，第一个杀死山贼的国家，若君主存在，则可由君主选择一个ID，自由学会" + app.roleLinkArray["1325"] + "的三个技能中的一个，但学来的【水能载舟】只能触发一次。若有2个或以上国家同时杀死山贼，则此技能无法触发。（无属性技能）"},
        ],
        attr: "统帅",
        faq: [],
        alias: []
        ...
        skills: [
            ...
            {name: "平反大将", content: "被动技能。当被非吴国人杀死时触发，第一个杀死海盗的国家，若君主存在，则可由君主选择一个ID，自由学会" + app.roleLinkArray["1325"] + "的三个技能中的一个，但学来的【水能载舟】只能触发一次。若有2个或以上国家同时杀死海盗，则此技能无法触发。（无属性技能）"},
        ],
        attr: "义士",
        faq: [],
        alias: []
        ...
        skills: [
            ...
            {name: "平反大将", content: "被动技能。当被" + app.roleLinkArray["1305"] + "所在国家之外的人杀死时触发，第一个杀死黄巾贼的国家，若君主存在，则可由君主选择一个ID，自由学会" + app.roleLinkArray["1325"] + "的三个技能中的一个，但学来的【水能载舟】只能触发一次。若有2个或以上国家同时杀死黄巾贼，则此技能无法触发。（无属性技能）"},
        ],
        attr: "猛将",
        faq: [],
        alias: []
